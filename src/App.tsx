...
function App() {
  ...
  return (
    <div className="relative min-h-screen bg-bg-deep text-brand-primary selection:bg-brand-accent/30 overflow-hidden font-sans">
      ...
      {/* Main Content Area */}
      <main className="h-screen w-full flex flex-col pt-24 pb-36 px-6 overflow-y-auto">
              ...
              {showPwaPrompt && (
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-xs text-white/60 mt-1">Add to your home screen for the full native experience.</p>
                  </div>
        ...
        {activeTab === 'lab' && (
          <motion.div 
            ...
            className="flex-1 flex flex-col space-y-6 pt-4"
          >
            <div>
            ...
            <div className="glass-panel p-6 space-y-4">
              ...
              <div className="grid grid-cols-3 gap-4 text-center">
                ...
                <div className="bg-white/5 p-3 rounded-xl">
                  ...
                  <div className="font-mono text-sm">{mag.isSupported ? mag.y.toFixed(1) : '-'}</div>
                </div>
                <div className="bg-white/5 p-3 rounded-xl">
            ...
            <div className="glass-panel p-6 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white/5 p-4 rounded-xl">
                  ...
                  <div className="font-mono text-sm">{location.accuracy ? `${location.accuracy.toFixed(2)}m` : '-'}</div>
                </div>
                <div className="bg-white/5 p-4 rounded-xl">
                  <div className="text-[10px] text-white/30 uppercase mb-1">Altitude</div>
                  <div className="font-mono text-sm">{location.altitude ? `${location.altitude.toFixed(1)}m` : '-'}</div>
                </div>
              </div>
            </div>
                ...
                <div className="p-5 flex justify-between items-center">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-white/50">{hasPermission ? 'Active & Calibrated' : 'Disabled'}</p>
                    </div>
                  </div>
                  <button 
                    onClick={() => hasPermission ? stopAccess() : requestAccess()}
                ...
                <div className="p-5 flex justify-between items-center">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-white/50">{(location.lat && location.lng) ? 'Active' : 'Disabled'}</p>
                    </div>
                  </div>
                  <button 
                    onClick={() => {
      ...
      <nav className="fixed bottom-8 inset-x-0 z-40 flex justify-center pointer-events-none">
        <div className="flex justify-between items-center gap-8 px-8 py-4 rounded-full bg-white/5 backdrop-blur-3xl border border-white/10 shadow-[0_10px_40px_rgba(0,0,0,0.5)] pointer-events-auto">
          ...
          >
            ...
            {activeTab === 'compass' && <div className="absolute -bottom-3 w-1 h-1 bg-brand-accent rounded-full shadow-[0_0_10px_var(--color-brand-accent)]" />}
          </button>
          ...
          >
            ...
            {activeTab === 'maps' && <div className="absolute -bottom-3 w-1 h-1 bg-brand-accent rounded-full shadow-[0_0_10px_var(--color-brand-accent)]" />}
          </button>
          ...
          >
            ...
            {activeTab === 'lab' && <div className="absolute -bottom-3 w-1 h-1 bg-brand-secondary rounded-full shadow-[0_0_10px_var(--color-brand-secondary)]" />}
          </button>
          ...
          >
            ...
            {activeTab === 'prefs' && <div className="absolute -bottom-3 w-1 h-1 bg-white rounded-full shadow-[0_0_10px_rgba(255,255,255,0.5)]" />}
          </button>
        </div>
      </nav>
